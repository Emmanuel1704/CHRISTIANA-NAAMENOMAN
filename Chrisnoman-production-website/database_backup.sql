...
-- Generated on 2026-08-27 18:16:24
...
CREATE TABLE ``users` `(`id` bigint unsigned NOT NULL AUTO_INCREMENT PRIMARY KEY AUTO_INCREMENT not null, `name` varchar(255) not null, `email` varchar(255) not null, `email_verified_at` datetime, `password` varchar(255) not null, `remember_token` varchar(255), `created_at` datetime, `updated_at` datetime);

-- Dumping data for table `users`
INSERT INTO `users` (`id`, `name`, `email`, `email_verified_at`, `password`, `remember_token`, `created_at`, `updated_at`) VALUES
('1', 'Admin Chrisnoman', 'Christiananaamenoman@gmail.com', '2026-08-27 10:41:30', '$2y$12$MV5J0n7ddteFWZGCDSdQIeg5IaScUuy4Uo4LT32BHbOSCUgaJZkhi', '2YNhMHryTd', '2026-08-27 10:41:30', '2026-08-27 10:41:30');
...
('VMv6NzsqKNwrzrBGjs515717gdDtDesNM4kjPjd1', '1', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/151.0.0.0 Safari/537.36', '', '1787842828'),
...
('MqbUouYR5qRFeo8G8rlGOZorhwp8BHm1Sgxhsfn9', NULL, '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/151.0.0.0 Safari/537.36', 'eyJfdG9rZW4iOiJVb1YyWXIwd1g1UktEQmp5MnU4cmZhbDF3RWI3UXNKOVhzZUNrOW5XIiwiX3ByZXZpb3VzIjp7InVybCI6Imh0dHA6XC9cL2xvY2FsaG9zdFwvZmFzaGlvblwvcHVibGljXC9zaXplLWd1aWRlIiwicm91dGUiOiJzaXplLWd1aWRlIn0sIl9mbGFzaCI6eyJvbGQiOltdLCJuZXciOltdfX0=', '1787854579');
