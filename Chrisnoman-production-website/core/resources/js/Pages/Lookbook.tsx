                    ...
                    <div className="grid gap-12 lg:grid-cols-12">
                        ...
                        <div className="lg:col-span-5 bg-brand-cream/20 dark:bg-brand-black/40 border border-brand-gold/15 p-8 rounded-3xl space-y-6 flex flex-col justify-between sticky top-28">
                            ...
                            <div className="space-y-3">
                                <a
                                    href={route('gown-builder') + `?silhouette=${
                                        selectedStyle === 'bridal' ? 'ballgown' : selectedStyle === 'corset' ? 'mermaid' : selectedStyle === 'african' ? 'aline' : 'pencil'
                                    }&fabric=${
                                        selectedFabric === 'kente' ? 'kente' : selectedFabric === 'brocade' ? 'brocade' : selectedFabric === 'silk_satin' ? 'silk' : 'satin'
                                    }`}
                                    className="w-full flex items-center justify-center space-x-3 bg-brand-black hover:bg-brand-gold hover:text-brand-black text-white font-bold py-4 px-6 rounded-full transition-all duration-300 text-xs uppercase tracking-widest text-center"
                                >
                                    <Sparkles className="h-4 w-4" />
                                    <span>Customize in Gown Builder</span>
                                </a>
