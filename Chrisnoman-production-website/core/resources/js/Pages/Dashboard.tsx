...
export default function Dashboard({ stats, salesData, recentBookings, recentMessages }: Props) {
    ...
    const cards = [
        ...
        { 
            ...
            bg: 'bg-orange-50',
            link: route('bookings.index', { status: 'pending' }) 
        },
        { 
                ...
                <div className="mx-auto max-w-7xl sm:px-6 lg:px-8 space-y-10">
                    ...
                    <div className="rounded-xl bg-[#141414] p-8 text-white shadow-lg border border-brand-gold/10 relative overflow-hidden">
                        ...
                        <div className="mt-8 grid gap-4 md:grid-cols-3">
                            <Link href={route('collections.create')} className="rounded-xl bg-zinc-900 border border-zinc-800 hover:border-brand-gold/40 px-6 py-4 text-sm font-semibold text-white hover:bg-zinc-800 transition-all flex items-center justify-between">
                            ...
                            <Link href={route('settings.index')} className="rounded-xl bg-brand-gold px-6 py-4 text-sm font-bold text-brand-black hover:bg-white transition-all flex items-center justify-between">
